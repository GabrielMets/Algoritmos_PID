# Programa responsavel por realizar executar o algoritmo de fechamento sobre a imagem 01.jpg
...
def fechamento(img, es):
    imagem_saida = erosao(dilatacao(img, es), es)
    return imagem_saida
...
def main():
    ...
    cv2.imshow("Imagem Fechada", cv2.resize(imagem_fechada, (400, 400)))
    cv2.waitKey(0)
